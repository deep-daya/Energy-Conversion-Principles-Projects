...
subplot(2,2,1)
plot(rc_i,transpose(Eta_tot),'.');
title('Subplot 1: Total Efficiency vs Variations in Incident Radiation');
subplot(2,2,2)
plot(rc_i,transpose(Eta_te),'.');
title('Subplot 1: Thermal Efficiency vs Variations in Incident Radiation');
subplot(2,2,3)
plot(rc_i,transpose(Eta_pv),'.');
title('Subplot 1: PV Efficiency vs Variations in Incident Radiation');
subplot(2,2,4)
plot(rc_i,transpose(P_tot), '.');
title('Subplot 1: Total Power vs Variations in Incident Radiation');
...
R =@(m_max) R_L/(n * m_max);
lam = @(R) Rlam_min / R;
fQ_C =@(T_C)  (k_w/t_w + U_ev) * (T_C-T_sat);
